...
var dog = Animal(species: "dog", tailLength: 10.3)
var cat = Animal(species: "cat", tailLength: 5.3)
//: __Problem 2__
//:
...
class Peach {
    ...
    static let varieties = ["soft1", "soft2", "soft3", "soft4", "soft5"]
...
func ripen() {
    ...
    if self.softness > 1 {
        ...
        print("You have to wait for eating!")
    }
}

let sweetPeach = Peach(variety: "soft", softness: 2 )
//: __Problem 3__
//:
//: __3a.__
